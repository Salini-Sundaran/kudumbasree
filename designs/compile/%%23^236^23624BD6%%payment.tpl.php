<?php /* Smarty version 2.6.26, created on 2022-02-15 06:27:33
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" name="month" class="text_box" type="text" value="" min="1" />	
																</li>
																<li>
																	<input type="number" name="year" class="text_box" type="text" value="" min="1" />	
																</li>
