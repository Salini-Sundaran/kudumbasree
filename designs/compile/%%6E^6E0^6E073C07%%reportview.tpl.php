<?php /* Smarty version 2.6.26, created on 2022-02-20 08:46:41
         compiled from reportview.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
"height="50px" width="100px" ><?php echo $this->_tpl_vars['a']['monthlyreport']; ?>
</td>
					<td><?php echo $this->_tpl_vars['a']['cdate']; ?>
</td>
					<td><?php echo $this->_tpl_vars['a']['cmonth']; ?>
</td>
					<td><a href="reportdelete.php?key=<?php echo $this->_tpl_vars['a']['rkey']; ?>
