<?php /* Smarty version 2.6.26, created on 2022-05-13 04:57:43
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1>
						<a href="index.php">KUDUMBASREE</a>
					</h1>
				</div>
				<div class="top-nav">
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Registration<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="userreg.php">Kudumbasree</a></li>
										<li><a class="hvr-bounce-to-bottom" href="employereg.php">Employee</a></li>  
										<li><a class="hvr-bounce-to-bottom" href="managerreg.php">Manager</a></li>
										<li><a class="hvr-bounce-to-bottom" href="clerkreg.php">Clerk</a></li>
										<li><a class="hvr-bounce-to-bottom" href="memberreg.php">Member</a></li>        
									</ul>
								</li>								
