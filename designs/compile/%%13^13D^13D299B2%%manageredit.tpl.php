<?php /* Smarty version 2.6.26, created on 2022-02-14 06:26:34
         compiled from manageredit.tpl */ ?>
...
"></td>
				...
				<tr>
					<td>Address</td>
					<td><textarea name="address" class="form-control"><?php echo $this->_tpl_vars['a']['address']; ?>
</textarea></td>
        </tr>
				<tr>
					<td>Pincode</td>
...
"><?php echo $this->_tpl_vars['c']['kudumbasree_name']; ?>
				...
				<tr>
					<td>Adhaar No</td>
                    <td><input type="text" name="adhar" class="form-control" value="<?php echo $this->_tpl_vars['a']['adhar']; ?>
"></td>
				</tr>
				<tr>
					<td>Contact No</td>
