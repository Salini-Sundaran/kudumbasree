<?php /* Smarty version 2.6.26, created on 2022-04-19 07:48:37
         compiled from membersmainheader.tpl */ ?>
...
<!--// css -->
<link rel="stylesheet" href="user/css/owl.carousel.css" type="text/css" media="all">
<link href="user/css/owl.theme.css" rel="stylesheet">
<!-- font-awesome icons -->
...
<body>
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1><b><i><a href="memberhome.php">KUDUMBASREE</a></i></b>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li><a class="active" href="memberhome.php">Home</a></li>
								<li><a href="about.html">About</a></li>
								<li><a href="memberedit.php">Profile Updation</a></li>
								<li><a href="membervnotification.php">Notifications</a></li>
								<li><a href="membervmeeting.php">Meeting</a></li>
								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Product<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="productview1.php">Product</a></li>
										<li><a class="hvr-bounce-to-bottom" href="membervproduct.php">Our Product</a></li> 
										<li><a class="hvr-bounce-to-bottom" href="addtocartview.php">My Cart</a></li>          
									</ul>
								</li>
									<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Message<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="message.php">Message Add</a></li>
										<li><a class="hvr-bounce-to-bottom" href="membervmessage.php">Message View</a></li>          
									</ul>
								</li>
								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">loan<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="loanviewmember.php">loan</a></li>
										<li><a class="hvr-bounce-to-bottom" href="payamountq.php">loan amount view</a></li>
										<li><a class="hvr-bounce-to-bottom" href="replayview.php">Message Replay</a></li>          
									</ul>
								</li>	
								...
								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Feedback<span class="caret"></span></a>
									<ul class="dropdown-menu">
										...
										<li><a class="hvr-bounce-to-bottom" href="feedbackmview.php">Feedback view</a></li>          
									</ul>
								</li>											
								<li><a href="membervevent.php">Events</a></li>					
