<?php /* Smarty version 2.6.26, created on 2022-04-19 18:26:30
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item"> -->
            ...
            <!-- <div class="media">
              ...
              <div class="media-body">
                ...
                <!-- </h3>
                <p class="text-sm">I got your mess age bro</p> -->
                <!-- <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Hours Ago</p>
              </div>
            </div> -->
            <!-- Message End -->
          ...
          <!-- </a> -->
          <div class="dropdown-divider"></div>
          <a href="adminvnotification.php" class="dropdown-item dropdown-footer"> Messages</a>
        </div>
      </li>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item">
            ...
            <ul class="nav nav-treeview"> -->
              <li class="nav-item">
                <a href="adminvkudumbasree.php" class="nav-link">
                  <p>UNITS VIEW</p>
                </a>
              </li>
         <!--  <li class="nav-header">EXAMPLES</li> -->
          ...
          <!-- </li> -->
          <li class="nav-item">
            <a href="adminnotification.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="adminvnotification.php" class="nav-link">
              <i class="nav-icon far fa-plus-square"></i>
              <p>
                Notification View
              </p>
          ...
          <li class="nav-item">
            <a href="admindreportv.php" class="nav-link">
              <i class="nav-icon far fa-plus-square"></i>
              <p>
                Dailywork report 
              </p>
          ...
          <li class="nav-item">
            <a href="loanview.php" class="nav-link">
              <i class="nav-icon far fa-plus-square"></i>
              <p>
                Loan View
              </p>
...
<script src="admin/dist/js/pages
.js"></script>
</body>
</html>
'; ?>
