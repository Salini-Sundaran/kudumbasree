<?php /* Smarty version 2.6.26, created on 2022-03-06 10:12:39
         compiled from employemainheader.tpl */ ?>
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1>
						<a href="employehome.php">KUDUMBASREE</a>
					</h1>
				</div>
				<div class="top-nav">
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li><a class="active" href="employehome.php">Home</a></li>
								<li><a href="about.html">About</a></li>
								<li><a href="employeedit.php">Profile Updation</a></li>
								<li><a href="sheduleviewemp.php">Shedule Work</a></li>
								<li><a href="employevevent.php">Events</a></li>
								<li><a href="loanvemploye.php">Loan</a></li>
								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Product<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="product.php">Product</a></li>
