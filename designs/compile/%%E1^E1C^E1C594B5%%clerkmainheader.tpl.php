<?php /* Smarty version 2.6.26, created on 2022-03-06 10:20:33
         compiled from clerkmainheader.tpl */ ?>
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1>
						<a href="clerkhomepage.php">KUDUMBASREE</a>
					</h1>
				</div>
				<div class="top-nav">
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li><a class="active" href="clerkhomepage.php">Home</a></li>
								<li><a href="about.html">About</a></li>
								<li><a href="clerkedit.php">Profile Updation</a></li>
                                 <li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Raw materials<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="rowmeterial.php">Raw materials Add</a></li>
										<li><a class="hvr-bounce-to-bottom" href="rowview.php">Raw materials View</a></li>          
									</ul>
								</li>
                                <li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Events<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="event.php">Events Add</a></li>
										<li><a class="hvr-bounce-to-bottom" href="eventview.php">Events View</a></li>          
									</ul>
								</li>								
