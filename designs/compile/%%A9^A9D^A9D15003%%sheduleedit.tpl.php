<?php /* Smarty version 2.6.26, created on 2022-03-06 07:56:24
         compiled from sheduleedit.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<form method="POST" action=""><input type="hidden" name="hidden" value="h">
		<center>
			<table>
				<tr>
					<td>Work Shedule</td>
					<td><textarea name="shedule" class="form-control"><?php echo $this->_tpl_vars['a']['shiftdetails']; ?>
</textarea></td>
				</tr>
				<tr>
					<td>Date</td>
