<?php /* Smarty version 2.6.26, created on 2022-05-09 08:06:30
         compiled from managermainheader.tpl */ ?>
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1>
						<a href="managerhome.php">KUDUMBASREE</a>
					</h1>
				</div>
				<div class="top-nav">
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="manageredit.php">Profile Updation</a></li>
								<li><a href="managervevent.php">Events</a></li>
								<li><a href="workvmanager.php">Daily Work</a></li>
								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Meeting Report<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="report.php">Meeting Report Add</a></li>
										<li><a class="hvr-bounce-to-bottom" href="reportview.php">Meeting Report view</a></li>          
									</ul>
								</li>

								<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Products<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="product.php">Products Add</a></li>
										<li><a class="hvr-bounce-to-bottom" href="productview.php">Product View</a></li>
										<li><a class="hvr-bounce-to-bottom" href="orders.php">Orders</a></li>          
									</ul>
								</li>						
